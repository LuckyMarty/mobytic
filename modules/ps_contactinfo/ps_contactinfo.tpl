  ...
  <i class="material-icons">location_on</i>
    ...
    {if $contact_infos.phone}
      ...
      {l s='Call us: [1]%phone%[/1]'
            sprintf=[
            '[1]' => "<a href='tel:{$contact_infos['phone']|replace:' ':''}' style='white-space: nowrap;'>",
      '[/1]' => '</a>',
    ...
    {if $contact_infos.email && $display_email}
      ...
      <a href="mailto:{$contact_infos.email}" aria-label="{$contact_infos.email}">{$contact_infos.email}</a>
    {/if}
  </div>
</div>