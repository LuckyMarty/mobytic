  ...
  {block name='login_form_container'}
    <section class="login-form">
      {block name='page_title'}
        <h1 class="h4">{l s='Log in to your account' d='Shop.Theme.Customeraccount'}</h1>
      {/block}
    ...
    {* <section class="no-account">
      <h2 class="h4">{l s='No account? Create one here' d='Shop.Theme.Customeraccount'}</h2>
      <a class="btn" href="{$urls.pages.register}" data-link-action="display-register-form">
        {l s='Create one now!' d='Shop.Theme.Customeraccount'}
      </a>
    </section> *}
...
{block name='mobytic_authentication_fullwidth'}
  {* Full screen *}
